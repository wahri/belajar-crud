...
<body>
    <div class="table-users">
        <div class="header text-dark">Data Mahasiswa</div>
        ...
        <div class="container my-3">
            <div class="row">
                ...
                <div class="col-md-4 text-center">
                    <h5 class="text-monospace text-light">Total : <?= mysqli_num_rows($query) ?></h5>
                </div>
    ...
    <!-- <footer class="bg-light py-3">
        <div class="container">
            <div class="small text-center text-light">Copyright © 2020 - Raden Arif Alhaj</div>
        </div>
    </footer> -->
